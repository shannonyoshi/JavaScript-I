...
console.log(`Last car make: ${inventory[lastCar].car_make}, model: ${inventory[lastCar].car_model}`);
...
let oldCars = carYears.filter(isOld);
console.log(`There are ${oldCars.length} cars made before the year 2000 on the lot.`); 
